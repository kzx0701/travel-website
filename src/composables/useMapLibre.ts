...
const COLOR = {
  ...
  landDefault: '#334155',
  landBorder: '#475569',
  provinceBorder: '#64748b',
  cityBorder: '#94a3b8',
  visitLow: 'rgba(255, 179, 128, 0.35)',
  visitMid: 'rgba(255, 107, 53, 0.38)',
  visitHigh: 'rgba(224, 90, 32, 0.42)',
  visitLowStroke: 'rgba(255, 179, 128, 0.7)',
  visitMidStroke: 'rgba(255, 107, 53, 0.8)',
  visitHighStroke: 'rgba(224, 90, 32, 0.9)',
  ...
  litProvince: 'rgba(255, 107, 53, 0.12)',
  unlitProvince: 'rgba(148, 163, 184, 0.06)',
  dotVisit: '#FF6B35',
  dotResidence: '#3B82F6',
} as const
...
export function useMapLibre(
  ...
  function initMap(): void {
    ...
    console.log('[useMapLibre] 初始化时容器尺寸:', rect.width, 'x', rect.height,
      'client:', containerRef.value.clientWidth, 'x', containerRef.value.clientHeight)
  ...
  function buildBaseStyle(): maplibregl.StyleSpecification {
    return {
      ...
      // 诊断模式：暂用默认 mercator 投影，确认基本渲染正常后再切回 globe
